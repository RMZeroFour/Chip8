...
namespace
{
    ...
    void updateJoystickLStickState(ImGuiIO &io)
    {
        ...
        if (s_currWindowCtx->lStickInfo.xInverted)
        ...
        if (s_currWindowCtx->lStickInfo.yInverted)
